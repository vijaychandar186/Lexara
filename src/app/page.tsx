  ...
  return (
    <>
      <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
        ...
        {/* Here is where you integrate the animation */}
        <p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
          <TypeAnimationComponent /> {/* Using the TypeAnimationComponent */}
        </p>
      ...
      <div className='mx-auto mb-32 mt-32 max-w-5xl sm:mt-56'>
        <div className='mb-12 px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl sm:text-center'>
            ...
            OCR for your PDF files has never been easier than with Lexara.
            </p>
          </div>
        </div>
        ...
        <ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                Either start out with a free plan or choose 
                one of our{' '}
                <Link
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='text-xl font-semibold'>
                Start processing PDF&apos;s
              </span>
              <span className='mt-2 text-zinc-700'>
                It&apos;s that simple. Try out Lexara today -
      ...
      <footer className='bg-gray-900 text-white py-8'>
        <div className='mx-auto max-w-6xl px-6 lg:px-8'>
          <div className='flex justify-center space-x-6'>
            <Link href='#' className='flex items-center justify-center w-10 h-10 bg-white rounded-full'>
              <Image 
